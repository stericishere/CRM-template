...
// Next.js-side timer helpers (fire-and-forget pattern)
//
...
export async function bestEffortStartTimer(
  ...
  try {
    ...
    // RPC functions added by proactive_operations migration — not in generated types yet
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    await (supabase.rpc as any)('create_or_reset_timer', {
...
export async function bestEffortCancelTimer(
  ...
  try {
    ...
    // RPC functions added by proactive_operations migration — not in generated types yet
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    await (supabase.rpc as any)('cancel_timer', {
      p_target_id: targetId,
      p_timer_type: timerType,
      p_reason: reason,
    })
